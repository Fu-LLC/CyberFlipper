...
- Protopirate (core protocol & hardware code)
- UberGuidoZ (IR/NFC/BadUSB/infrared datasets & tools)
- Sasquatch (NFC/BadUSB payloads)
- See stats.html and dashboard for full legal references and additional contributors.

All code is used under the terms of the original licenses. No explicit creator branding is present; for legal compliance, major sources are cited above and in the dashboard. See LICENSE for details.
