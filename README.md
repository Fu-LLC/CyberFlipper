...
<p align="center">
  <strong>[ CYBERFLIPPER v1.0.0 : OFFICIAL PRODUCTION RELEASE ]</strong><br>
  <em>Maintained by Personfu @ <a href="https://fllc.net">fllc.net</a> | NEON_DUSK_PROTOCOL</em>
</p>
...
2. Unmount the Flipper's memory card (SD Card).
3. Migrate the entire CYBERFLIPPER directory strictly to SD:\update\CYBERFLIPPER.
4. Run update.fuf natively from the Hardware File Browser.
